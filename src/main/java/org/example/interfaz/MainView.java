...
public class MainView {
    ...
    public MainView(MainController controller) {
        ...
        root.setCenter(new BusquedaView(controller));

        
        btnBusqueda.setOnAction(e -> openView(new BusquedaView(controller)));
        ...
        btnEstado.setOnAction(e -> openView(new EstadoView(controller)));
